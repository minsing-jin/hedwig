...
**Hedwig은 사용자가 자연어·upvote·질문으로 자신의 추천 알고리즘을 조각하는, 크로스플랫폼 멀티모달 신호를 critical/daily/weekly/on-demand 네 층위로 소비하는 인지 증강 엔진.**

기업 알고리즘(engagement 최적화) ↔ Hedwig(내 니즈 최적화, **내가 소유**)
...
2. Triple-Input Sculpting      — 3경로 입력이 하나의 fitness로 수렴
3. Self-Evolving Fitness       — daily/weekly/monthly 3층 진화
4. 4-Tier Temporal Lattice     — 한 엔진이 네 시간축 서빙
